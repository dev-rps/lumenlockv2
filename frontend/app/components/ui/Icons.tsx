...
function createIcon(displayName: string, pathElements: React.ReactNode) {
...
export const Layers = createIcon(
  ...
  <>
    ...
    <path d="m22 12.5-9.42 4.28a2 2 0 0 1-1.66 0L1.5 12.5" />
    <path d="m22 17.5-9.42 4.28a2 2 0 0 1-1.66 0L1.5 17.5" />
  </>
);
